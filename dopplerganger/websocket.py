...
class WebSocketHandler(tornado.web.RequestHandler):
    ...
    def _execute(self, transforms, *args, **kwargs):
        ...
        version = int(self.request.headers.get("Sec-WebSocket-Version", 0))
        logging.debug("Got WS version %d", version)
        if version >= 7 and version < 76:
...
class WebSocketProtocol8(WebSocketProtocol):
    ...
    def _challenge_response(self):
        ...
        return tornado.escape.utf8(base64.b64encode(sha1.digest()))
    ...
    def close(self):
        ...
        try:
            ...
            # If we get an IOerror, it's already gone
            self._abort()
